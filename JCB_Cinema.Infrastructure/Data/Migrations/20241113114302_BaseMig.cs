    ...
    public partial class BaseMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesProjection", x => x.MovieProjectionId);
                    table.ForeignKey(
                        name: "FK_MoviesProjection_CinemaHalls_CinemaHallId",
                        column: x => x.CinemaHallId,
                        principalTable: "CinemaHalls",
                        principalColumn: "CinemaHallId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesProjection_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingTickets_MovieProjectionId",
                table: "BookingTickets",
